...
const App = () => {
  ...
  const editionDropAddress = "0xa6df7673899Cd5E72fdE64db9aF7f6e501476F63"
  const { contract: editionDrop } = useContract(editionDropAddress, "edition-drop");
  // Initialize our token contract
  const { contract: token } = useContract('0x2Bbf608C9d16cd127c8a7e9B2EAF5a18CFE03Ac6', 'token');

  const { contract: vote } = useContract("0x91903fa5F95dbC619731f0483aB601e74C471e7c", "vote");
